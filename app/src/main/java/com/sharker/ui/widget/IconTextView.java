 ...
 * 1. 类的用途
 * 2. @author：liqingyi
 * 3. @date：2017/4/9 08:07
 */

public class IconTextView extends BaseTabItem {
    ...
    public IconTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(R.layout.item_icon_text, this, true);
